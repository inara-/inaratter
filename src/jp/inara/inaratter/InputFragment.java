...
public class InputFragment extends Fragment implements LoaderCallbacks<Boolean> {
    ...
    /**
     * Twitter ToggleButton の チェック変更時にActivityに通知するためのリスナー
     * 
     * @author inara
     */
    public interface OnTwitterButtonCheckedChangeListener {
         ...
         * Twitterトグルボタンのリスナー
         * 
         * @param buttonView CompoundButtonオブジェクト
    ...
    /**
     * Facebook ToggleButtonのチェック変更時にActivityに通知するためのリスナー
     * 
     * @author inara
     */
    public interface OnFacebookButtonCheckedChangeListener {
         ...
         * Facebookトグルボタンのリスナー
         * 
         * @param buttonView {@link CompoundButton}オブジェクト
         * @param isChecked チェックされているかどうか
         */
    ...
    public void onLoadFinished(Loader<Boolean> arg0, Boolean arg1) {
        ...
        Toast.makeText(getActivity(), "Postしました。", Toast.LENGTH_SHORT).show();
        getActivity().finish();
    }

    /**
     * Facebookのウォールへ投稿するためのリスナー
     * 
     * @author inara
     */
